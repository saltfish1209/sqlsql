...
OLLAMA_MODEL_TAG="${OLLAMA_MODEL_TAG:-supergemma4-26b-uncensored-fast-v2-q4km}"
OLLAMA_MODEL_PATH="${OLLAMA_MODEL_PATH:-/data2/yj/models/supergemma4-26b-uncensored-fast-v2-Q4_K_M.gguf}"
...
OLLAMA_MODELS="${OLLAMA_MODELS:-/data2/yj/ollama/models}"
...
# 单卡 GGUF 实验默认串行处理请求，降低 KV cache 和显存压力
