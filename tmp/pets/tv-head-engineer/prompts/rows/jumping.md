Create one horizontal animation strip for Codex pet `tv-head-engineer`, state `jumping`.
...
Extra state direction: make this a small lively hop, not a dramatic jump, and keep the relaxed friendly personality.
